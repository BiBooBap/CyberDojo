...
async function initializeDB() {
        ...
        validator: {
            $jsonSchema: {
                ...
                properties: {
                    ...
                    punti: { bsonType: 'int', minimum: 0, description: 'Punti dell\'utente' },
    ...
    validator: {
        $jsonSchema: {
            ...
            properties: {
                ...
                utente_username: { bsonType: 'string', description: 'Username dell\'utente che ha fatto il test' },
            ...
            domande: [
                {
                    ...
                    risposte: ['let è block-scoped, var è function-scoped', 'Non c\'è differenza', 'let è più lento di var'],
                    corretta: 0
                }
            ]
        }
        ...
        domande: [
            {
                ...
                risposte: ['== confronta solo il valore, === confronta valore e tipo', 'Non c\'è differenza', '=== è più lento di =='],
                corretta: 0
            }
        ]
    },
        ...
        domande: [
            {
                ...
                risposte: ['Gestire operazioni asincrone', 'Gestire variabili globali', 'Gestire eventi DOM'],
                corretta: 0
            }
        ]
    }
    ...
    validator: {
        $jsonSchema: {
            ...
            properties: {
                utente_username: { bsonType: 'string', description: 'Username dell\'utente che ha aperto il ticket' },
                descrizione: { bsonType: 'string', description: 'Descrizione del problema' },
                admin_username: { bsonType: 'string', description: 'ID dell\'admin che ha gestito il ticket (opzionale)' },
...
await db.collection('ticket').insertMany([
    {
        ...
        },
        {
            ...
            descrizione: 'Errore durante il pagamento per l\'iscrizione al corso premium',
            data_creazione: new Date()
        },
        {
    ...
    validator: {
        $jsonSchema: {
            bsonType: 'object',
            required: ['utente_username', 'corso_id', 'descrizione', 'punti', 'data'],
            properties: {
                utente_username: { bsonType: 'string', description: 'Username dell\'utente che ha ricevuto il premio' },
...
await db.collection('premi').insertMany([
    ...
    validator: {
        $jsonSchema: {
            ...
            properties: {
                utente_username: { bsonType: 'string', description: 'Username dell\'utente proprietario dell\'inventario' },
                oggetti: {
                    bsonType: 'array',
                    items: {
                        bsonType: 'object',
